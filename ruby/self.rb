...
#Perceba que a variável self não precisa ser declarada. Ela é disponível 
#em qualquer lugar, mas não esqueça que seu valor é referente ao objeto que pertence.